...
- ช่วยอธิบายหน่อยว่า OOP คืออะไร ประกอบไปด้วยอะไรบ้าง  แล้วมันดียังไง ?
      ...
      OOP ทำให้เราสามารถเขียนโค้ดที่สะอาดตาอ่านง่าย ประหยัดเวลา เพราะ ลดการทำงานซ้ำ และบำรุงรักษาง่าย
  
            OOP จะมองทุกอย่างเป็น object (class) ออบเจ็บหนึ่งอย่างจะประกอบไปด้วย 2 ส่วน คือ ลักษณะ (Atribute)/หน้าตา/UI (variables)
      และ สิ่งที่มันทำได้/Behavier (method)
  <br/>
